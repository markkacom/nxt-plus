...
public class GetChatMessages extends APIServlet.APIRequestHandler{
    ...
    JSONStreamAware processRequest(HttpServletRequest req) throws ParameterException {
        ...
        Account accountOne = ParameterParser.getAccount(req, "accountOne", true);
        Account accountTwo = ParameterParser.getAccount(req, "accountTwo", true);
        ...
        info = accountTwo.getAccountInfo();
        if (info != null) {
