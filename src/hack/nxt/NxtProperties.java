...
public class NxtProperties {
  ...
  static void setup() {
    ...
    Properties properties = loadProperties(new String[] {
        System.getProperty("user.home") + "/git/nxt-plus/conf/nxt-default.properties",
        System.getProperty("user.home") + "/git/nxt-plus/conf/nxt.properties", 
    });
    ...
    try {
      Properties loggingProperties = loadProperties(new String[] { System.getProperty("user.home") + "/git/nxt-plus/conf/logging.properties"});
